...
public:
	...
	float m_visibility_ranges[settings::NUMBER_OF_LOD_LEVELS];
	bool m_sort_by_distance = false;
	bool m_vis_dist_too_small = false;
	float m_morph_start[settings::NUMBER_OF_LOD_LEVELS];
	float m_morph_end[settings::NUMBER_OF_LOD_LEVELS];
